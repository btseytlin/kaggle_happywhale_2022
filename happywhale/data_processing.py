...
def load_train_test_dfs(csv_dir_path, train_images_path, test_images_path):
    train_df = pd.read_csv(os.path.join(csv_dir_path, 'train.csv'))
    ...
    test_df = pd.read_csv(os.path.join(csv_dir_path, 'test.csv'))
